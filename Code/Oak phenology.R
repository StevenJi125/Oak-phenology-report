...
plot(plotting_2021$Year,plotting_2021$Mean.leaf.bursts.score,xlab="Years",ylab="Mean bud burst scores",col="darkgreen",cex.lab=1.5)
...
plotting_2021<-read.csv("~/Downloads/Oak phenology data.csv")
plot(plotting_2021$Year,plotting_2021$Mean.air.temperature....C,xlab="Years",ylab="Mean air temperatures (°C)",col="darkred",cex.lab=1.5)
...
plot(plotting_2021$Mean.air.temperature....C,plotting_2021$Mean.leaf.bursts.score,xlab="Mean air temperatures (°C)",ylab="Mean bud burst scores",cex.lab=1.5)
